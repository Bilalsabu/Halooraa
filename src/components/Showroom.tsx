    ...
    <section className="bg-[var(--color-black)] text-white py-24 md:py-40 px-6 md:px-16 relative overflow-hidden border-t border-white/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="md:col-span-4 flex justify-center my-12 md:my-0">
          ...
          >
            <img src="https://picsum.photos/seed/showroom/1000/1200" alt="Showroom" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80" referrerPolicy="no-referrer" />
