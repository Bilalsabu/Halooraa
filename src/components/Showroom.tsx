  ...
  return (
    <section className="bg-[var(--color-black)] text-white py-24 md:py-40 px-6 md:px-16 relative overflow-hidden border-t border-white/10">
      <div className="flex items-center gap-3 mb-16 border-t border-white/10 pt-8">
        ...
        <span className="font-display text-[10px] md:text-xs tracking-[0.3em] uppercase font-light text-gradient-gold">Sales Gallery</span>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
        <div className="md:col-span-4">
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-light tracking-tight leading-[1.2]">
            Experience the <span className="italic text-gradient-gold">art</span> of <span className="italic text-gradient-gold">luxury</span> living.
          </h2>
        </div>
        ...
        <div className="md:col-span-4 flex justify-center my-12 md:my-0">
          <div 
            ...
            className="w-full aspect-video md:aspect-[3/4] max-w-md overflow-hidden relative group cursor-pointer border border-white/10 group-hover:border-[var(--color-gold)] transition-colors duration-500"
          >
            <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&w=1000&q=80" alt="Showroom" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80" referrerPolicy="no-referrer" />
      ...
      <ContactModal 
        ...
        title="Schedule a Gallery Visit"
      />
    </section>
  );
}
